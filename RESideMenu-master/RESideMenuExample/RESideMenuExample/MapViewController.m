...
- (void)viewDidLoad
{
    ...
    _mapView = [[MKMapView alloc] initWithFrame: CGRectMake(0, 44, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height - 44)];
...
-(CLLocationCoordinate2D)zzTransGPS:(CLLocationCoordinate2D)yGps
{
    ...
    NSArray *aa = [self.managedObjectContext executeFetchRequest: request error: nil];
    NSLog(@"aa count = %d", [aa count]);
